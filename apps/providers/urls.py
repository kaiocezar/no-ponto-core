...
urlpatterns = [
    ...
    path("me/working-hours/bulk/", WorkingHoursBulkView.as_view(), name="provider-working-hours-bulk"),
    path("me/working-hours/<uuid:pk>/", WorkingHoursDetailView.as_view(), name="provider-working-hours-detail"),
    # Schedule Blocks
    path("me/blocks/", ScheduleBlockListCreateView.as_view(), name="provider-schedule-blocks"),
    path("me/blocks/<uuid:pk>/", ScheduleBlockDetailView.as_view(), name="provider-schedule-block-detail"),
    # Public availability
    path("<slug:slug>/availability/", ProviderAvailabilityView.as_view(), name="provider-availability"),
